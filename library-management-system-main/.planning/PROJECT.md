...
- [x] Users can register and log in with separate student and librarian roles.
- [x] Students can browse, search, and filter the book catalog.
- [x] Students can submit borrowing requests and librarians can approve or reject them.
- [x] The system tracks active loans, returns, due dates, and overdue status.
- [x] The system sends overdue alerts by email.
- [x] Librarians can add, edit, and remove catalog books.
- [x] Librarians can view a dashboard with borrowing statistics and overdue books.

### Active

(None currently — MVP scope is implemented and ready for manual evaluation)
...
|----------|-----------|---------|
| Build a role-based web application | Students and librarians need different capabilities within one system | Accepted and implemented |
| Use Flask, Jinja templates, and SQLite | Keeps the system in one Python codebase and reduces setup and integration work | Accepted and implemented |
| Run with Python virtual environments | Avoids Docker and separate service setup while remaining reproducible through pinned dependencies | Accepted and documented |
| Limit v1 to physical-book circulation | Keeps the four-week scope focused on the core library workflow | Accepted and implemented |
