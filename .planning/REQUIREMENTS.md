...
- [ ] **AUTH-01**: Student can register with email and password.
- [ ] **AUTH-02**: Registered user can log in and log out.
- [ ] **AUTH-03**: System restricts features according to student or librarian role.

### Catalog

- [ ] **CAT-01**: Student can browse the book catalog.
- [ ] **CAT-02**: Student can search books by title, author, or ISBN.
- [ ] **CAT-03**: Student can filter books by category and availability.
- [ ] **CAT-04**: Student can view book details and current availability.
